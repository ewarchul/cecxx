...
struct layout_stride {
    ...
    public:
        ...
        static_assert(detail::__is_extents_v<Extents>, "std::experimental::layout_stride::mapping must be instantiated "
                                                       "with a specialization of std::experimental::extents.");
    ...
    private:
        ...
        _MDSPAN_HOST_DEVICE constexpr index_type __get_size(::std::experimental::extents<SizeType, Ep...>,
...
#endif
    {
        ...
        MDSPAN_TEMPLATE_REQUIRES(class... Indices,
                                 /* requires */ (sizeof...(Indices) == Extents::rank()
                                                 && _MDSPAN_FOLD_AND(_MDSPAN_TRAIT(is_convertible, Indices,
                                                                                   index_type) /*&& ...*/)

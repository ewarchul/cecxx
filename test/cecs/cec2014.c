...
IS_NOT_USED static void sphere_func (double *, double *, int , double *,double *, int, int); /* Sphere */
static void ellips_func(double *, double *, int , double *,double *, int, int); 
static void bent_cigar_func(double *, double *, int , double *,double *, int, int);
static void discus_func(double *, double *, int , double *,double *, int, int); 
IS_NOT_USED static void dif_powers_func(double *, double *, int , double *,double *, int, int);  
static void rosenbrock_func (double *, double *, int , double *,double *, int, int); 
IS_NOT_USED static void schaffer_F7_func (double *, double *, int , double *,double *, int, int);
static void ackley_func (double *, double *, int , double *,double *, int, int); 
static void rastrigin_func (double *, double *, int , double *,double *, int, int);
static void weierstrass_func (double *, double *, int , double *,double *, int, int);
static void griewank_func (double *, double *, int , double *,double *, int, int);
static void schwefel_func (double *, double *, int , double *,double *, int, int);
static void katsuura_func (double *, double *, int , double *,double *, int, int);
IS_NOT_USED static void bi_rastrigin_func (double *, double *, int , double *,double *, int, int);
static void grie_rosen_func (double *, double *, int , double *,double *, int, int);
static void escaffer6_func (double *, double *, int , double *,double *, int, int); 
IS_NOT_USED static void step_rastrigin_func (double *, double *, int , double *,double *, int, int);
static void happycat_func (double *, double *, int , double *,double *, int, int); 
static void hgbat_func (double *, double *, int , double *,double *, int, int); 

static void hf01 (double *, double *, int, double *,double *, int *,int, int); 
static void hf02 (double *, double *, int, double *,double *, int *,int, int); 
static void hf03 (double *, double *, int, double *,double *, int *,int, int); 
static void hf04 (double *, double *, int, double *,double *, int *,int, int); 
static void hf05 (double *, double *, int, double *,double *, int *,int, int); 
static void hf06 (double *, double *, int, double *,double *, int *,int, int); 

static void cf01 (double *, double *, int , double *,double *, int); 
static void cf02 (double *, double *, int , double *,double *, int); 
static void cf03 (double *, double *, int , double *,double *, int); 
static void cf04 (double *, double *, int , double *,double *, int); 
static void cf05 (double *, double *, int , double *,double *, int); 
static void cf06 (double *, double *, int , double *,double *, int); 
static void cf07 (double *, double *, int , double *,double *, int *, int); 
static void cf08 (double *, double *, int , double *,double *, int *, int); 

static void shiftfunc (double*,double*,int,double*);
static void rotatefunc (double*,double*,int, double*);
static void sr_func (double *, double *, int, double*, double*, double, int, int); 
IS_NOT_USED static void asyfunc (double *, double *x, int, double);
IS_NOT_USED static void oszfunc (double *, double *, int);
...
void cec14_test_func(double *x, double *f, int nx, int mx,int func_num)
{
	...
	if (ini_flag==0)
	{
		...
		/* Load Matrix M*/
		sprintf(FileName, "../data/cec2014/M_%d_D%d.txt", func_num,nx);
		...
		/* Load shift_data */
		sprintf(FileName, "../data/cec2014/shift_data_%d.txt", func_num);
		fpt = fopen(FileName,"r");
		if (fpt==NULL)
		{
			printf("\n Error: Cannot open input file for reading \n");
		...
		{
			sprintf(FileName, "../data/cec2014/shuffle_data_%d_D%d.txt", func_num, nx);
			fpt = fopen(FileName,"r");
			if (fpt==NULL)
			{
				printf("\n Error: Cannot open input file for reading \n");
...
IS_NOT_USED static void sphere_func (double *x, double *f, int nx, double *Os, double *Mr, int s_flag, int r_flag) 
{
  int i;
  f[0] = 0.0;
...
static void ellips_func (double *x, double *f, int nx, double *Os,double *Mr, int s_flag, int r_flag) 
{
    int i;
  f[0] = 0.0;
  sr_func (x, z, nx, Os, Mr,1.0, s_flag, r_flag); 
...
static void bent_cigar_func (double *x, double *f, int nx, double *Os,double *Mr, int s_flag, int r_flag) 
{
    int i;
  sr_func (x, z, nx, Os, Mr,1.0, s_flag, r_flag); 
...
static void discus_func (double *x, double *f, int nx, double *Os,double *Mr, int s_flag, int r_flag) 
{
    int i;
  sr_func (x, z, nx, Os, Mr,1.0, s_flag, r_flag); 
...
IS_NOT_USED static void dif_powers_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
  int i;
  f[0] = 0.0;
  sr_func (x, z, nx, Os, Mr, 1.0, s_flag, r_flag); 
...
static void rosenbrock_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
  double tmp1,tmp2;
  f[0] = 0.0;
  sr_func (x, z, nx, Os, Mr, 2.048/100.0, s_flag, r_flag); 
...
IS_NOT_USED static void schaffer_F7_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
  double tmp;
    f[0] = 0.0;
...
static void ackley_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
    double sum1, sum2;
    sum1 = 0.0;
...
static void weierstrass_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i,j,k_max;
    double sum,sum2, a, b;
    a = 0.5;
  ...
  sr_func (x, z, nx, Os, Mr, 0.5/100.0, s_flag, r_flag); 
...
static void griewank_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
    double s, p;
    s = 0.0;
...
static void rastrigin_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
  f[0] = 0.0;
...
static void step_rastrigin_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
  f[0]=0.0;
  for (i=0; i<nx; i++)
...
static void schwefel_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
  double tmp;
  f[0]=0.0;
...
static void katsuura_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i,j;
...
static void bi_rastrigin_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
...
static void grie_rosen_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
...
static void escaffer6_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
    int i;
    double temp1, temp2;
...
static void happycat_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
{
  int i;
...
static void hgbat_func (double *x, double *f, int nx, double *Os,double *Mr,int s_flag, int r_flag) 
...
static void hf01 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) 
{
  int i,tmp,cf_num=3;
  double fit[3];
  int G[3],G_nx[3];
...
static void hf02 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) 
{
  int i,tmp,cf_num=3;
  double fit[3];
  int G[3],G_nx[3];
...
static void hf03 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) 
{
  int i,tmp,cf_num=4;
  double fit[4];
  int G[4],G_nx[4];
...
static void hf04 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) 
{
  int i,tmp,cf_num=4;
  double fit[4];
  int G[4],G_nx[4];
...
static void hf05 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) 
{
  int i,tmp,cf_num=5;
  double fit[5];
  int G[5],G_nx[5];
...
static void hf06 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) 
{
  int i,tmp,cf_num=5;
  double fit[5];
  int G[5],G_nx[5];
...
static void cf01 (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) 
{
  int i,cf_num=5;
  double fit[5];
...
static void cf02 (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) 
{
  int i,cf_num=3;
  double fit[3];
...
static void cf03 (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) 
{
  int i,cf_num=3;
  double fit[3];
...
static void cf04 (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) 
{
  int i,cf_num=5;
  double fit[5];
...
static void cf05 (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) 
{
  int i,cf_num=5;
  double fit[5];
...
static void cf06 (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) 
{
  int i,cf_num=5;
  double fit[5];
  double delta[5] = {10,20,30,40,50};
...
static void cf07 (double *x, double *f, int nx, double *Os,double *Mr,int *SS,int r_flag) 
{
  int i,cf_num=3;
  double fit[3];
  double delta[3] = {10,30,50};
...
static void cf08 (double *x, double *f, int nx, double *Os,double *Mr,int *SS,int r_flag)
{
  int i,cf_num=3;
  double fit[3];
  double delta[3] = {10,30,50};
...
static void shiftfunc (double *x, double *xshift, int nx,double *Os)
{
  int i;
    for (i=0; i<nx; i++)
    {
...
static void rotatefunc (double *x, double *xrot, int nx,double *Mr)
{
  int i,j;
    for (i=0; i<nx; i++)
    {
...
static void sr_func (double *x, double *sr_x, int nx, double *Os,double *Mr, double sh_rate, int s_flag,int r_flag) 
{
  int i;
  if (s_flag==1)
  {
...
IS_NOT_USED static void asyfunc (double *x, double *xasy, int nx, double beta)
{
  int i;
    for (i=0; i<nx; i++)
    {
...
IS_NOT_USED static void oszfunc (double *x, double *xosz, int nx)
{
  int i,sx;
  double c1,c2,xx;
    for (i=0; i<nx; i++)
...
static void cf_cal(double *x, double *f, int nx, double *Os,double * delta,double * bias,double * fit, int cf_num)
{
  int i,j;
  double *w;

...
static void cf02_s (double *, double *, int , double *,double *, int); /* Composition Function 2 for shift case*/
static void cf04_s (double *, double *, int , double *,double *, int); /* Composition Function 4 for shift case*/
static void cf05_s (double *, double *, int , double *,double *, int); /* Composition Function 5 for shift case*/
...
void cec21_basic_func(double *x, double *f, int nx, int mx,int func_num)
{
	...
	if (ini_flag==0)
	{
		...
		/* Load Matrix M*/
		sprintf(FileName, "../data/cec2021/M_%d_D%d_nr.txt", func_num,nx);
		...
		/* Load shift_data */
		sprintf(FileName, "../data/cec2021/shift_data_%d_ns.txt", func_num);
		fpt = fopen(FileName,"r");
		if (fpt==NULL)
		{
		...
		{
			sprintf(FileName, "../data/cec2021/shuffle_data_%d_D%d.txt", func_num, nx);
			fpt = fopen(FileName,"r");
			if (fpt==NULL)
			{
...
void cec21_bias_rot_func(double *x, double *f, int nx, int mx,int func_num)
{
	...
	if (ini_flag==0)
	{
		...
		/* Load Matrix M*/
		sprintf(FileName, "../data/cec2021/M_%d_D%d.txt", func_num,nx);
		fpt = fopen(FileName,"r");
		if (fpt==NULL)
		{
...
void cec21_bias_shift_func(double *x, double *f, int nx, int mx,int func_num)
{
	...
	if (ini_flag==0)
	{
		...
		/* Load shift_data */
		sprintf(FileName, "../data/cec2021/shift_data_%d.txt", func_num);
		fpt = fopen(FileName,"r");
		if (fpt==NULL)
		{
...
static void hf01 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) /* Hybrid Function 1  /F17 Hybrid Function 1 in cec2014*/
{
	int i,tmp,cf_num=3;
	double fit[3];
	int G[3],G_nx[3];
...
static void hf05 (double *x, double *f, int nx, double *Os,double *Mr,int *S,int s_flag,int r_flag) // hf5 in cec2014 F21 in cec2014
{
	int i,tmp,cf_num=5;
	double fit[5];
	int G[5],G_nx[5];
...
static void cf02_s (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) /* Composition Function 2 */
{
	int i,cf_num=3;
	double fit[3];
	double delta[3] = {10,20,30};
...
static void cf04_s (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) /* Composition Function 3 */
{
	int i,cf_num=4;
	double fit[4];
	double delta[4] = {10,20,30,40};
...
static void cf05_s (double *x, double *f, int nx, double *Os,double *Mr,int r_flag) /* Composition Function 4 */
{
	int i,cf_num=5;
	double fit[5];
	double delta[5] = {10,20,30,40,50};
